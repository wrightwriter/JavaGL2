...
//    var uIters = UniformFloat("uIters", 16.0f, this)
    ...
    var uAoRad = UniformFloat("uAoRad", 0.17f, this)
    var uAoPow = UniformFloat("uAoPow", 2.0f, this)
...
//    var uAoInt = UniformInt("uAoRad", 1, this)
    ...
    init{
        ...
        fb = FB(_width = _resolution.x, _height = _resolution.y, _name = "SSAO")
    }
